...
# Although two different variables are holding the number 5, they point to the same object in memory. 
# However, consider the next code example:
a = "hello"
b = "hello"
a.equal?(b) #=> false
...
# Ruby has a special operator that is affectionately referred to as the spaceship operator. 
# Unlike the other comparison operators, which all return true or false, 
